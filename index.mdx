...
Ranger Earn opens up access to sophisticated yield generation strategies on Solana to anyone. Through our Vaults, users can participate in automated yield optimization without requiring deep knowledge of underlying DeFi protocols or complex trading strategies.

Ranger Earn is a permissionless framework enabling anyone — from renowned hedge funds to boutique funds — to create and manage yield-generating vaults. These vaults automatically identify and allocate capital to the most attractive opportunities across Solana's DeFi ecosystem.
...
<CardGroup cols={2}>
  ...
  <Card title="DeFi Protocols" icon="plug" href="/protocols/overview">
    Integrate your protocol with Ranger Earn vaults via custom adaptors
  </Card>
