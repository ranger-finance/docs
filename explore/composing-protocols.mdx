...
description: Use CPI to build new DeFi primitives on top of Ranger Earn vaults
---

Build on top of Ranger Earn vaults via Cross-Program Invocation — tranching, fractional reserve, derivatives, and more.
