---
title: Cancel Request Withdraw
description: CPI instruction to cancel a pending withdrawal request
---
...
<Info>
This instruction can be called at any time after a [`request_withdraw_vault`](/protocols/cpi-integration/request-withdraw) has been created, regardless of whether the waiting period has passed.
</Info>
...
Full reference implementation: [cancel_request_withdraw_vault.rs](https://github.com/ranger-finance/vault-cpi/blob/main/references/cancel_request_withdraw_vault.rs)
