---
title: Deposit
description: CPI instruction to deposit assets into a Ranger Earn vault
---
...
Full reference implementation: [deposit_vault.rs](https://github.com/ranger-finance/vault-cpi/blob/main/references/deposit_vault.rs)
