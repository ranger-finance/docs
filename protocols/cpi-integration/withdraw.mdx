---
title: Withdraw
description: CPI instruction to complete a withdrawal from a Ranger Earn vault
---
...
<Warning>
This instruction will fail with `WithdrawalNotYetAvailable` if the vault's `withdrawal_waiting_period` has not passed since the [`request_withdraw_vault`](/protocols/cpi-integration/request-withdraw) call.
</Warning>
...
Full reference implementation: [withdraw_vault.rs](https://github.com/ranger-finance/vault-cpi/blob/main/references/withdraw_vault.rs)
