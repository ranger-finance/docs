...
description: CPI instruction to initiate a withdrawal from a Ranger Earn vault
---
...
<Warning>
After calling `request_withdraw_vault`, the user must wait for the vault's `withdrawal_waiting_period` to pass before calling [`withdraw_vault`](/protocols/cpi-integration/withdraw) to claim the underlying assets.
</Warning>
...
Full reference implementation: [request_withdraw_vault.rs](https://github.com/ranger-finance/vault-cpi/blob/main/references/request_withdraw_vault.rs)
