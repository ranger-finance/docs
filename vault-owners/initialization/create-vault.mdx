...
<Info>
You can also create a vault without code at [vaults.ranger.finance/create](https://vaults.ranger.finance/create). See [Quick Start (UI)](/vault-owners/initialization/via-ui).
</Info>
