...
Ranger Earn enforces role separation between admin and manager:
...
<Info>
You can also create a vault through the UI at [vaults.ranger.finance/create](https://vaults.ranger.finance/create). See [Quick Start (UI)](/vault-owners/initialization/via-ui).
</Info>
